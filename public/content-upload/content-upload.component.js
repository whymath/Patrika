...
angular.module('contentUpload').
  component('contentUpload',{
    templateUrl: 'content-upload/content-upload.template.html',
    controller: ['$routeParams','$location','SvnLinks','$localStorage','authentication',
      function contentUploadController ($routeParams,$location,SvnLinks,$localStorage,authentication) {
        var self = this;
